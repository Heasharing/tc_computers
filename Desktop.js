...
import Pcdata from '../components/product/Pcdata';
import './stylesheet/Pc.css';
...
const Desktop = ({sortBy}) => {
  ...
  const sortedData = [...Pcdata].sort((a, b) => {
          ...
          {sortedData.map(product => {
            ...
            return (
              <div key={product.id} className="laptop-card">
                ...
                <img className="pc-image" src={product.image} alt={product.name}></img>
                <h2>{product.name}</h2>
